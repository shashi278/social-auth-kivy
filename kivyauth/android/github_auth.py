...
from kivyauth.android.firebase_auth import firebase_login, firebase_logout, initialize_firebase, OAuthProvider, auto_firebase as auto_github
...
def initialize_github(succes_listener, error_listener, *args):
